...
insert into hall (hall_name, hall_area, hall_addr, hall_tel, hall_site, hall_seat, hall_image)
values('블루스퀘어 신한카드홀', '서울', '서울특별시 용산구 이태원로 294 블루스퀘어(한남동)', '1544-1591',
...
-- 경기/인천
insert into hall (hall_name, hall_area, hall_addr, hall_tel, hall_site, hall_seat, hall_image)
values('고양아람누리 아람극장', '경기/인천', '경기도 고양시 일산동구 마두동 816, 817번지', '1577-7766',
'http://www.artgy.or.kr/', 225, '고양아람누리 아람극장.PNG');
insert into hall (hall_name, hall_area, hall_addr, hall_tel, hall_site, hall_seat, hall_image)
values('경기아트센터 대극장', '경기/인천', '경기도 수원시 팔달구 효원로307번길 20 경기아트센터', '031-230-3400',
'http://www.ggac.or.kr', 225, '경기아트센터.PNG');
-- 충청/대전
insert into hall (hall_name, hall_area, hall_addr, hall_tel, hall_site, hall_seat, hall_image)
values('천안예술의전당', '충청/대전', '충남 천안시 동남구 성남면 종합휴양지로 185', '1566-0155',
'http://www.cnac.or.kr', 225, '천안예술의전당.PNG');
-- 경상/대구/부산
insert into hall (hall_name, hall_area, hall_addr, hall_tel, hall_site, hall_seat, hall_image)
values('부산드림씨어터', '경상/대구/부산', '부산광역시 남구 전포대로 133(문현동) 드림씨어터', '1833-3755',
'https://www.dreamtheatre.co.kr/', 225, '부산 드림씨어터.PNG');
insert into hall (hall_name, hall_area, hall_addr, hall_tel, hall_site, hall_seat, hall_image)
values('창원 성산아트홀 대극장', '경상/대구/부산', '경상남도 창원시 의창구 중앙대로 181 (용호동 2)', '055-268-7900',
'http://www.cwcf.or.kr/facility/facility_sungsan.asp', 225, '창원 성산아트홀.PNG');
-- 전라/광주
insert into hall (hall_name, hall_area, hall_addr, hall_tel, hall_site, hall_seat, hall_image)
values('한국소리문화의전당 모악당', '전라/광주', '전라북도 전주시 덕진구 덕진동1가 산1-1', '063-270-8000',
'http://www.sori21.co.kr/', 225, '한국소리문화전당.PNG');
insert into hall (hall_name, hall_area, hall_addr, hall_tel, hall_site, hall_seat, hall_image)
values('광주예술의전당 대극장', '전라/광주', '광주광역시 북구 북문대로 60(운암동) 광주예술의전당', '062-613-8333',
'https://gjart.gwangju.go.kr/ko/cmd.do?opencode=p07052', 225, '광주예술의전당.PNG');
-- 강원
insert into hall (hall_name, hall_area, hall_addr, hall_tel, hall_site, hall_seat, hall_image)
values('춘천 봄내극장', '강원', '강원특별자치도 춘천시 서부대성로 71(옥천동) 춘천 봄내극장', '033-253-7111',
'https://bomnae.chuncheon.go.kr/', 225, '춘천 봄내극장.PNG');
-- 제주
insert into hall (hall_name, hall_area, hall_addr, hall_tel, hall_site, hall_seat, hall_image)
values('제주 한라아트홀', '제주', '제주 제주시 한라대학로 38 (노형동) 한라아트홀 대극장(한라대학교)', '033-253-7111',
'https://www.chu.ac.kr/', 225, '제주 한라아트홀.PNG');

-- 연극(2-중)
-- 서울
insert into hall (hall_name, hall_area, hall_addr, hall_tel, hall_site, hall_seat, hall_image)
values('시윤아트홀', '서울', '서울특별시 종로구 대학로 116(동숭동) 지하1층 시윤아트홀', '02-1661-3123',
'https://www.playdb.co.kr/placedb/PlacedbInfo.asp?PlacecCD=6526', 100, '시윤아트홀.PNG');
insert into hall (hall_name, hall_area, hall_addr, hall_tel, hall_site, hall_seat, hall_image)
values('서연아트홀', '서울', '서울특별시 종로구 창경궁로 258-9 (명륜2가) 서연아트홀', '070-5180-5956',
'https://blog.naver.com/ddanent', 100, '서연아트홀.PNG');
insert into hall (hall_name, hall_area, hall_addr, hall_tel, hall_site, hall_seat, hall_image)
values('해피씨어터', '서울', '서울시 종로구 동숭동 1-60번지 지하 1층', '02-742-7611',
'https://blog.naver.com/mcc1612', 100, '해피씨어터.PNG');
insert into hall (hall_name, hall_area, hall_addr, hall_tel, hall_site, hall_seat, hall_image)
values('산울림 소극장', '서울', '서울시 마포구 서교동 327-9', '02-334-5915',
'http://perform.kcaf.or.kr/sanwoollim/', 100, '산울림 소극장.PNG');
-- 경기/인천
insert into hall (hall_name, hall_area, hall_addr, hall_tel, hall_site, hall_seat, hall_image)
values('수원SK아트리움', '경기/인천', '경기도 수원시 장안구 정자동 600-30 (이목로 24-25)', '0507-1346-1864',
'http://suwonskartrium.or.kr', 100, '수원 SK 아트리움.PNG');
insert into hall (hall_name, hall_area, hall_addr, hall_tel, hall_site, hall_seat, hall_image)
values('광교 매직앤조이', '경기/인천', '경기 수원시 영통구 광교중앙로 124 , 갤러리아 광교 10층 매직앤조이', '031-250-5300',
'https://www.mirinemagic.com/', 100, '광교 매직앤조이.PNG');
-- 충청/대전
insert into hall (hall_name, hall_area, hall_addr, hall_tel, hall_site, hall_seat, hall_image)
values('이수아트홀', '충청/대전', '대전광역시 서구 탄방동 748 , 정우빌딩 지하 1층', '0507-1378-4325',
'https://www.instagram.com/open_daham/', 100, '작은극장 다함.PNG');
insert into hall (hall_name, hall_area, hall_addr, hall_tel, hall_site, hall_seat, hall_image)
values('작은극장 다함', '충청/대전', '대전광역시 동구 대전로448번길 70 (가오동)', '0507-1468-2117',
'https://isuart.modoo.at/', 100, '이수아트홀.PNG');
-- 경상/대구/부산
insert into hall (hall_name, hall_area, hall_addr, hall_tel, hall_site, hall_seat, hall_image)
values('문화예술전용극장 CT', '경상/대구/부산', '대구광역시 중구 남일동 109-2 제일빌딩 지하 1층', '053-256-0369',
'https://m.cafe.daum.net/artCT/UrK0?boardType=', 100, '문화예술전용극장 CT.PNG');
insert into hall (hall_name, hall_area, hall_addr, hall_tel, hall_site, hall_seat, hall_image)
values('부산메트로홀', '경상/대구/부산', '부산시 수영구 수영로576, 광안역 안 B1층 (5번 출구 안)', '1600-0316',
'https://blog.naver.com/playthebusan', 100, '부산 메트로홀.PNG');
-- 전라/광주
insert into hall (hall_name, hall_area, hall_addr, hall_tel, hall_site, hall_seat, hall_image)
values('전주 한해랑아트홀', '전라/광주', '전라북도 전주시 완산구 효자동2가 1155-10 돌핀빌딩 3층 301호 한해랑아트홀', '1644-4356',
'https://www.cusmore.com/h/16444356', 100, '전주 한해랑아트홀.PNG');
insert into hall (hall_name, hall_area, hall_addr, hall_tel, hall_site, hall_seat, hall_image)
values('상무지구 기분좋은극장', '전라/광주', '광주광역시 서구 상무중앙로 90 대교빌딩 7층 (우리은행 상무지점 건물)', '1600-6689',
...
-- 서울
insert into hall (hall_name, hall_area, hall_addr, hall_tel, hall_site, hall_seat, hall_image)
values('올림픽 공원', '서울', '서울특별시 송파구 올림픽로 424 (방이동 88-2) 올림픽공원', '02-410-1114',
'https://www.inspirekorea.com/ko/entertainment/inspire.arena/inspire.arena', 400, '올림픽공원.PNG');
insert into hall (hall_name, hall_area, hall_addr, hall_tel, hall_site, hall_seat, hall_image)
values('신한카드 SOL 페이 스퀘어 라이브홀', '서울', '서울특별시 마포구 양화로 45 메세나폴리스 2 층 (서교동 490)', '1588-1555',
'http://www.solpay.square.com', 400, '신한카드 SOL페이 스퀘어 라이브홀.PNG');
insert into hall (hall_name, hall_area, hall_addr, hall_tel, hall_site, hall_seat, hall_image)
values('연세대학교 대강당', '서울', '서울특별시 서대문구 신촌동 134 연세대학교 대강당', '02-2123-2114',
'http://ycac.yonsei.ac.kr/', 400, '연세대학교 대강당.PNG');
insert into hall (hall_name, hall_area, hall_addr, hall_tel, hall_site, hall_seat, hall_image)
values('마포아트센터 아트홀 맥', '서울', '서울특별시 마포구 대흥로20길 28(대흥동) 아트홀맥', '02-3274-8600',
'https://www.mfac.or.kr/', 400, '마포아트센터.PNG');
-- 경기/인천
insert into hall (hall_name, hall_area, hall_addr, hall_tel, hall_site, hall_seat, hall_image)
values('고양종합운동장 주경기장', '경기/인천', '경기도 고양시 일산서구 대화동 2320', '031-929-4861',
'https://www.gys.or.kr/subpage/index/293', 400, '고양종합운동장.PNG');
insert into hall (hall_name, hall_area, hall_addr, hall_tel, hall_site, hall_seat, hall_image)
values('인스파이어 아레나', '경기/인천', '인천광역시 중구 공항문화로 127(운서동)', '032-580-9000',
'https://www.inspirekorea.com/ko/entertainment/inspire.arena/inspire.arena', 400, '인스파이어 아레나.PNG');
-- 충청/대전
insert into hall (hall_name, hall_area, hall_addr, hall_tel, hall_site, hall_seat, hall_image)
values('대전 컨벤션센터 제2전시장', '충청/대전', '대전광역시 유성구 엑스포로 107(도룡동) 제2전시장', '042-250-1100',
'https://www.dcckorea.or.kr/index.do', 400, '대전 컨벤션센터.PNG');
-- 경상/대구/부산
insert into hall (hall_name, hall_area, hall_addr, hall_tel, hall_site, hall_seat, hall_image)
values('구미문화예술회관 대공연장', '경상/대구/부산', '경상북도 구미시 송정대로 89 구미시문화예술회관(송정동 75번지)', '054-480-4560',
'https://www.gumi.go.kr/arts/main.do', 400, '구미문화예술회관.PNG');
insert into hall (hall_name, hall_area, hall_addr, hall_tel, hall_site, hall_seat, hall_image)
values('경남문화예술회관 대공연장', '경상/대구/부산', '경상남도 진주시 강남로 215 (칠암동)', '032-580-9000',
'https://artcenter.gyeongnam.go.kr/concert/concertScheduleList.md', 400, '경남문화예술회관.PNG');
-- 전라/광주
insert into hall (hall_name, hall_area, hall_addr, hall_tel, hall_site, hall_seat, hall_image)
values('GS칼텍스 예율마루', '전라/광주', '전라남도 여수시 예울마루로 100 (시전동 1002)', '1544-7669',
'http://www.yeulmaru.org/', 400, '예울마루.PNG');
insert into hall (hall_name, hall_area, hall_addr, hall_tel, hall_site, hall_seat, hall_image)
values('전북대학교 삼성문화회관', '전라/광주', '전라북도 전주시 덕진구 백제대로 567(금암동) 삼성문화회관', '063-270-2089',
'https://cnucc.jbnu.ac.kr/', 400, '삼성문화회관.PNG');
-- 강원
insert into hall (hall_name, hall_area, hall_addr, hall_tel, hall_site, hall_seat, hall_image)
values('백령아트센터', '강원', '강원 춘천시 강원대학길 1', '033-250-7201',
...
-- 뮤지컬
-- 1.로맨틱코미디                         장르 공연장
insert into performance values(null, 1, 1, 5, '써니텐', '2024-09-09', '2024-10-09', 100, '써니텐.jpg', 8, 'p', null, null, null);
insert into performance values(null, 1, 1, 2, '인사이드미', '2024-09-06', '2024-10-10', 110, '인사이드미.jpg', 10, 'p', null, null, null);
insert into performance values(null, 1, 1, 8, '김종욱 찾기', '2024-10-01', '2024-12-09', 100, '김종욱 찾기.jpg', 7, 'p', null, null, null);

-- 2.드라마
insert into performance values(null, 1, 1, 1, '시카고', '2024-09-09', '2024-10-09', 145, '시카고.PNG', 14, 'p', null, null, null);
insert into performance values(null, 1, 2, 3, '부치하난', '2024-09-17', '2024-11-17', 160, '부치하난.PNG', 14, 'p', "화,수,목 19:30 / 금 15:00, 19:30 / 토 15:00, 19:30 / 일,공휴일 14:00, 18:30 / 월 공연없음<br>
* 공연없음 : 9/17(화) 14:00, 9/20(금) 15:00, 9/29(일) 14:00, 18:30 , 10/4(금) 15:00", null, 'sangse5.jpg');
insert into performance values(null, 1, 2, 1, '광화문연가', '2024-10-23', '2025-01-05', 160, '광화문연가.png', 8, 'w', null, null, null);
insert into performance values(null, 1, 2, 4, '베르사유의 장미', '2024-07.16', '2025-10-13', 150, '베르사유의 장미.png', 8, 'p', null, null, null);
insert into performance values(null, 1, 2, 2, '킹키부츠', '2024-09-07', '2025-11-10', 155, '킹키부츠.png', 8, 'p', null, null, null);
insert into performance values(null, 1, 2, 9, '썸데이', '2024-09-01', '2024-10-31', 100, '썸데이.PNG', 7, 'p', null, null, null);
insert into performance values(null, 1, 2, 10, '어서 오세요, 휴남동 서점입니다', '2024-10-05', '2024-11-10', 100, '어서 오세요, 휴남동 서점입니다.PNG', 7, 'p', "수-목 19:30│금 16:30, 19:30│토 14:00, 17:00│일 14:00│월-화 휴관<br>
*10/9(수) 14:00, 17:00<br>
*10/30(수) 16:30, 19:30", "*10/18(금) 16:30 -> 15:30 변경<br>
해당 회차 학생 단체 관람 예정입니다. 예매 시 참고부탁드립니다.", 'sangse10.jpg');

-- 3.코믹
insert into performance values(null, 1, 3, 2, '젠틀맨스 가이드', '2024-07-06', '2024-10-20', 150, '젠틀맨스 가이드.PNG', 14, 'p', null, null, null);
insert into performance values(null, 1, 3, 3, '뱀프X헌터', '2024-9-15', '2024-12-21', 90, '뱀프X헌터.jpg', 12, 'p', null, null, null);
insert into performance values(null, 1, 3, 5, '프리즌', '2010-09-01', '2024-12-30', 90, '프리즌.jpg', 9, 'p', null, null, null);
insert into performance values(null, 1, 3, 7, '인피니티 플라잉', '2024-03-23', '2024-11-30', 80, '인피니티 플라잉.PNG', 3, 'p', null, null, null);

-- 4.공포/스릴러
insert into performance values(null, 1, 4, 3, '하데스타운', '2024-07-12', '2024-10-06', 155, '하데스타운.png', 8, 'p', null, null, null);
insert into performance values(null, 1, 4, 11, '진짜나쁜소녀', '2024-05-08', '2024-10-30', 100, '진짜나쁜소녀.PNG', 16, 'p', "[9월]<br>
화~목 19:30<br>
금요일 16:00 19:30<br>
토요일 15:00 19:00<br>
일요일&공휴일 15:00<br><br>
...
-- 5.퍼포먼스
insert into performance values(null, 1, 5, 3, '애니', '2024-10-01', '2024-10-27', 135, '애니.PNG', 5, 'p', null, null, null);
insert into performance values(null, 1, 5, 2, '스파이', '2024-09-26', '2024-10-28', 120, '스파이.png', 14, 'p', null, null, null);
insert into performance values(null, 1, 5, 13, '난타', '2024-09-26', '2024-11-20', 90, '난타.jpg', 1, 'p', null, null, null);
insert into performance values(null, 1, 5, 1, '와일드', '2024-08-16', '2024-12-31', 75, '와일드.jpg', 19, 'p', null, null, null);
insert into performance values(null, 1, 5, 4, '페인터즈', '2024-09-26', '2024-10-21', 75, '페인터즈.jpg', 1, 'p', "예매가능시간: 전일17시(월~토 관람 시)까지/전일 11시(일요일 관람 시)까지<br><br>

공연 시간 : 월요일~일요일 14시, 17시, 20시", null, 'sangse21.jpg');
-- 6.어린이
insert into performance values(null, 1, 6, 9, '베베핀 뮤지컬', '2024-09-21', '2024-09-22', 65, '베베핀 뮤지컬.jpg', 1, 'f', null, null, null);
insert into performance values(null, 1, 6, 3, '어린왕자', '2024-08-02', '2024-09-29', 50, '어린왕자.jpg', 3, 'f', null, null, null);
insert into performance values(null, 1, 6, 5, '오리지널 어린이 캣', '2024-10-30', '2024-11-20', 70, '오리지널 어린이 캣.jpg', 3, 'w', null, null, null);
insert into performance values(null, 1, 6, 6, '인어공주', '2024-09-26', '2024-12-26', 50, '인어공주.jpg', 1, 'p', null, null, null);
insert into performance values(null, 1, 6, 1, '피노키오', '2024-03-23', '2024-10-28', 75, '피노키오.jpg', 1, 'p', null, null, null);

-- 연극
-- 1.로맨틱코미디                         장르 공연장
insert into performance values(null, 2, 1, 22, '행복총량의 법칙', '2024-08-17', '2024-10-30', 90, '행복총량의 법칙.jpg', 8, 'p', null, null, null);
insert into performance values(null, 2, 1, 15, '비누향기', '2024-10-10', '2024-12-20', 110, '비누향기.jpg', 12, 'w', null, null, null);
insert into performance values(null, 2, 1, 14, '은밀한 연애', '2024-03-12', '2024-10-31', 75, '은밀한 연애.PNG', 12, 'p', "[9월]<br>
...
insert into performance values(null, 2, 1, 16, '라면', '2024-04-04', '2024-10-31', 100, '라면.PNG', 11, 'p', null, null, null);
insert into performance values(null, 2, 1, 14, '핫식스', '2017-09-14', '2024-10-31', 120, '핫식스.PNG', 19, 'p', "［9월 공연시간］<br>
월화수목 : 4시30분<br>
금 : 3시20분, 6시30분<br>
...
-- 2.드라마
insert into performance values(null, 2, 2, 16, '버나르도&프란시스코', '2024-08-17', '2024-10-13', 95, '버나르도&프란시스코.PNG', 7, 'p', "평일 20시 / 토,공휴일 14시, 18시 / 일요일 16시<br>
* 월요일, 9월 17일 공연 없음", "※ 매수제한: 회차별 1인 4매<br><br>

※ 9월10일(화) ~ 9월15일(일) 페어 엽서 증정 이벤트", 'sangse32.jpg');
insert into performance values(null, 2, 2, 15, '나와 할아버지', '2024-09-24', '2024-11-24', 90, '나와 할아버지.PNG', 10, 'p', null, null, null);
insert into performance values(null, 2, 2, 18, '이방인', '2024-08-23', '2024-09-22', 100, '이방인.PNG', 15, 'f', "평일 8시 | 토 3시, 7시 | 일 및 공휴일 3시 | 화 쉼", "* 9월 6일(금) 8시 회차는 '2024 야간 공연 관람권 사업'으로 인하여 미오픈됩니다.<br>
* 9월 21일(토) 3시 회차는 단체 관람으로 인해 일부 좌석이 마감되었습니다.<br>
예매 시 참고 부탁드립니다. 감사합니다.", 'sanagse34.jpg');
insert into performance values(null, 2, 2, 20, '로스트', '2024-09-11', '2025-01-05', 60, '로스트.PNG', 15, 'p', "평일(월~금): 19:30<br>
토/일/공휴일: 15:30", null, 'sangse35.jpg');
insert into performance values(null, 2, 2, 19, '불편한 편의점', '2023-04-08', '2024-11-17', 100, '불편한 편의점.PNG', 7, 'p', "* 수-금 19:30 │ 토 14:00, 17:00 │ 일 14:00 │ 월, 화 휴관<br><br>
...
-- 3.코믹
insert into performance values(null, 2, 3, 17, '2호선 세입자', '2024-11-11', '2024-12-30', 100, '2호선 세입자.jpg', 14, 'w', null, null, null);
insert into performance values(null, 2, 3, 23, '런투패밀리', '2024-08-02', '2024-12-30', 90, '런투패밀리.jpg', 9, 'p', null, null, null);
insert into performance values(null, 2, 3, 18, '죽여주는 이야기', '2023-07-01', '2024-11-13', 100, '죽여주는 이야기.PNG', 8, 'p', null, null, null);
insert into performance values(null, 2, 3, 16, '오백에 삼십', '2015-11-21', '2024-10-31', 100, '오백에 삼십.PNG', 11, 'p', null, null, null);
insert into performance values(null, 2, 3, 21, '너의 목소리가 들려', '2018-12-06', '2024-10-20', 100, '너의 목소리가 들려.PNG', 12, 'p', null, null, null);

-- 4.공포/스릴러
insert into performance values(null, 2, 4, 14, '그곳에 있었다', '2023-09-01', '2024-10-16', 70, '그곳에 있었다.jpg', 13, 'p', null, null, null);
insert into performance values(null, 2, 4, 25, '쉬어매드니스', '2024-07-25', '2024-10-17', 110, '쉬어매드니스.jpg', 16, 'p', null, null, null);
insert into performance values(null, 2, 4, 24, '자취', '2020-02-28', '2024-10-18', 80, '자취.jpg', 13, 'p', null, null, null);
insert into performance values(null, 2, 4, 18, '크리미널 시즌4', '2024-07-12', '2024-10-09', 90, '크리미널 시즌4.jpg', 13, 'p', null, null, null);
insert into performance values(null, 2, 4, 19, '오마이갓', '2017-07-01', '2024-11-15', 90, '오마이갓.PNG', 12, 'p', "［ 9월 공연시간 ］<br>
...
-- 6.어린이
insert into performance values(null, 2, 6, 16, '북극곰예술여행', '2019-07-20', '2024-10-30', 60, '북극곰 예술여행.PNG', 2, 'p', null, null, null);
insert into performance values(null, 2, 6, 15, '아빠와 난 초등1학년', '2024-10-11', '2024-10-13', 60, '아빠와 난 초등1학년.PNG', 3, 'w', null, null, null);
insert into performance values(null, 2, 6, 14, '시간을 파는 상점', '2016-10-08', '2024-10-27', 90, '시간을 파는 상점.PNG', 8, 'p', "［9~10월 공연 시간］<br>
금: 17:00<br>
...
insert into performance values(null, 2, 6, 20, '난 토마토 절대 안 먹어', '2024-11-08', '2024-11-09', 50, '난 토마토 절대 안 먹어.PNG', 3, 'w', null, null, null);
insert into performance values(null, 2, 6, 23, '따라가면 안돼', '2024-10-01', '2024-10-02', 50, '따라가면 안돼.PNG', 3, 'f', null, null, null);

-- 발라드
insert into performance values(null, 3, 13, 27, '2024 린(LYn) 콘서트 〈HOME〉', '2024-10-05', '2024-10-06', 100, '2024 린(LYn) 콘서트 〈HOME〉.png', 7, 'w', "1회차: 2024년 10월 5일(토) 오후 3시<br>
...
insert into performance values(null, 3, 13, 30, '사나사숲 콘서트', '2024-10-19', '2024-10-19', 100, '사나사숲 콘서트.png', 6, 'w', "토요일 PM 7 : 00 ~ 9 : 00", "***가을맞이(추석 포함) <파격 할인 행사>를 펼칩니다. 많은 팬분들께 양평 사나사 계곡과 용문산 숲의 아름다움 속에서 '발라드 음악의 정수'를 즐길 수 있는 기회를
...
insert into performance values(null, 3, 13, 28, '윤시내 콘서트', '2024-11-23', '2024-11-23', 120, '윤시내 콘서트.png', 8, 'w', null, null, null);
insert into performance values(null, 3, 13, 29, '이광조 콘서트 the vocalist', '2024-10-05', '2024-10-05', 120, '이광조 콘서트 the vocalist.png', 7, 'w', "2024년 10월 05일 토요일 18:00", null, 'sangse55.jpg');
-- 락
insert into performance values(null, 3, 14, 31, '나이트레이지 내한 첫 서울공연 on HELLRIDE 26', '2024-10-26', '2024-10-26', 210, '나이트레이지 내한 첫 서울공연 on HELLRIDE 26.png', 1, 'w', null, null, null);
insert into performance values(null, 3, 14, 26, '리플렉스 단독공연', '2024-10-05', '2024-10-05', 150, '리플렉스 단독공연.png', 1, 'w', null, null, null);
insert into performance values(null, 3, 14, 35, '블랙홀 정홍일 Twin Concert', '2024-10-12', '2024-10-12', 150, '블랙홀 정홍일 Twin Concert.png', 1, 'w', null, null, null);
insert into performance values(null, 3, 14, 35, '점프투게더', '2024-10-05', '2024-10-05', 200, '점프투게더.png', 1, 'w', null, null, null);
insert into performance values(null, 3, 14, 31, 'Legend Blues Band 신촌블루스 - 화성', '2024-10-26', '2024-10-26', 90, 'Legend Blues Band 신촌블루스 - 화성.png', 7, 'w', null, null, null);
insert into performance values(null, 3, 14, 29, 'SOUND ATTACK Vol.3', '2024-09-20', '2024-09-20', 130, 'SOUND ATTACK Vol.3.png', 1, 'f', null, null, null);
-- 힙합
insert into performance values(null, 3, 15, 30, 'NOWITZKI LIVE', '2024-09-21', '2024-09-22', 100, 'NOWITZKI LIVE.png', 14, 'f', "9월 21일 토요일 오후 5시<br>
9월 22일 일요일 오후 5시", null, 'sangse62.jpg');
insert into performance values(null, 3, 15, 31, '2024 어텐션 라이브 #2 - 용인', '2024-09-28', '2024-09-28', 90, '2024 어텐션 라이브2 - 용인.png', 8, 'f', null, null, null);
insert into performance values(null, 3, 15, 33, 'COUNTDOWN', '2024-10-19', '2024-10-19', 100, 'COUNTDOWN.png', 15, 'w', null, null, null);
insert into performance values(null, 3, 15, 28, 'Super Rookie Challenge', '2024-09-13', '2024-09-13', 180, 'Super Rookie Challenge.png', 1, 'f', null, null, null);
-- 트로트
insert into performance values(null, 3, 16, 31, '2024 장윤정 라이브 콘서트 - 성남', '2024-10-19', '2024-10-19', 120, '2024 장윤정 라이브 콘서트 - 성남.png', 8, 'w', "2024년 10월 19일(토) 오후 2시, 6시", "※ 티켓분실 및 미지참시 재발권 및 입장은 절대불가하오니 티켓보관에 유의하시기 바랍니다.<br>
※ 8세이상 초등학생이 관람 할 경우, 현장에서 나이 확인이 가능한 증빙서류를 지참하시기 바랍니다.<br>
※ 10매이상 예매를 원할경우 인터파크 고객센터(1544-1555)로 문의바랍니다.", 'sangse66.jpg');
insert into performance values(null, 3, 16, 33, 'ASAC 송년콘서트 〈김연자 데뷔 50주년 콘서트-블링블링 아모르파티〉-안산', '2024-12-21', '2024-12-21', 120, 'ASAC 송년콘서트 〈김연자 데뷔 50주년 콘서트-블링블링 아모르파티〉-안산.png', 7, 'w', null, null, null);
insert into performance values(null, 3, 16, 30, '〈10월의 봄〉 정훈희x송창식with 함춘호 콘서트 - 고양', '2024-10-05', '2024-10-05', 120, '〈10월의 봄〉 정훈희x송창식with 함춘호 콘서트 - 고양.png', 7, 'w', null, null, null);
insert into performance values(null, 3, 16, 34, '〈미스트롯3〉 전국투어 콘서트 - 진주', '2024-09-28', '2024-09-28', 150, '〈미스트롯3〉 전국투어 콘서트 - 진주.png', 8, 'f', "공연일정 : 2024년 9월 28일(토) / 1일 2회 공연<br>
...
insert into performance values(null, 3, 16, 37, '2024 심수봉 전국투어콘서트 : 꽃길 - 군포', '2024-11-23', '2024-11-23', 120, '2024 심수봉 전국투어콘서트 꽃길 - 군포.png', 8, 'w', null, null, null);
insert into performance values(null, 3, 16, 35, '2024 오누이 “우리들의 학창시절” 〈김용임,진성〉 - 여수', '2024-09-14', '2024-09-14', 120, '2024 오누이 “우리들의 학창시절” 〈김용임,진성〉 - 여수.png', 7, 'f', null, null, null);
insert into performance values(null, 3, 16, 36, '2024 오누이 시즌2 “우리들의 무명시절” 〈김용임,진성〉 - 전주', '2024-10-12', '2024-10-12', 120, '2024 오누이 시즌2 “우리들의 무명시절” 〈김용임,진성〉 - 전주.png', 7, 'w', null, null, null);
insert into performance values(null, 3, 16, 33, '2024 장윤정 라이브 콘서트 - 대구', '2024-09-28', '2024-09-28', 120, '2024 장윤정 라이브 콘서트 - 대구.png', 8, 'f', null, null, null);
insert into performance values(null, 3, 16, 34, '2024 주현미 콘서트 〈The Original〉 - 부산', '2024-10-13', '2024-10-13', 100, '2024 주현미 콘서트 〈The Original〉 - 부산.png', 7, 'w', null, null, null);
insert into performance values(null, 3, 16, 33, '2024 주현미 콘서트 〈The Original〉 - 구미', '2024-10-03', '2024-10-03', 100, '2024 주현미 콘서트 〈The Original〉 - 구미.png', 7, 'f', null, null, null);
insert into performance values(null, 3, 16, 29, '2024 추석특집 주현미 콘서트 〈The Original〉', '2024-09-21', '2024-09-21', 100, '2024 추석특집 주현미 콘서트 〈The Original〉.png', 7, 'f', null, null, null);
insert into performance values(null, 3, 16, 31, '7080 낭만 극장쇼 - 용인', '2024-08-10', '2024-12-07', 60, '7080 낭만 극장쇼 - 용인.png', 15, 'p', null, null, null);
insert into performance values(null, 3, 16, 35, '박인희 앵콜＂ 콘서트', '2024-09-21', '2024-09-21', 120, '박인희 앵콜 콘서트.png', 7, 'f', null, null, null);
insert into performance values(null, 3, 16, 36, '정태춘,박은옥 콘서트 - 전주', '2024-09-28', '2024-09-28', 120, '정태춘,박은옥 콘서트 - 전주.png', 7, 'f', null, null, null);
insert into performance values(null, 3, 16, 34, '진성 30주년 기념 콘서트 〈진성 빅쇼〉 - 부산', '2024-09-21', '2024-09-21', 120, '진성 30주년 기념 콘서트 〈진성 빅쇼〉 - 부산.png', 12, 'f', "2024년 9월 21일(토) 14:00 / 18:00", null, 'sangse80.jpg');
insert into performance values(null, 3, 16, 34, '진성 30주년 기념 콘서트 〈진성 빅쇼〉 - 울산', '2024-10-05', '2024-10-05', 120, '진성 30주년 기념 콘서트 〈진성 빅쇼〉 - 울산.png', 12, 'w', "2024년 10월 5일 [토요일] 1회차 : 14시 / 2회차 : 18시", null, 'sangse81.jpg');
insert into performance values(null, 3, 16, 31, '진성 30주년 기념 콘서트 〈진성 빅쇼〉 - 인천', '2024-11-30', '2024-11-30', 120, '진성 30주년 기념 콘서트 〈진성 빅쇼〉 - 인천.png', 12, 'w', "2024년 11월 30일(토) 14:00 / 18:00", null, 'sangse82.jpg');
insert into performance values(null, 3, 16, 34, '진성 30주년 기념 콘서트 〈진성 빅쇼〉 - 창원', '2024-09-28', '2024-09-28', 120, '진성 30주년 기념 콘서트 〈진성 빅쇼〉 - 창원.png', 12, 'f', "2024년 09월 28일 [토요일] 1회차: 14:00시 / 2회차: 18:00시", null, 'sangse83.jpg');
insert into performance values(null, 3, 16, 30, '추가열과 이상우의 포크콘서트 - 연천', '2024-10-12', '2024-10-12', 120, '추가열과 이상우의 포크콘서트 - 연천.png', 8, 'w', null, null, null);
insert into performance values(null, 3, 16, 37, '포크 포에버', '2024-09-22', '2024-09-22', 120, '포크 포에버.png', 8, 'f', null, null, null);
