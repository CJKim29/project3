...
public class MemberController {
	...
	@ResponseBody
    public Map<String, String> photoModify(@RequestParam int mem_idx, @RequestParam("photo") MultipartFile photo) throws IllegalStateException, IOException {
        
        // 파일 업로드 처리
        // Spring Boot에서 resources 폴더에 저장하는 예시
        //String absPath = new ClassPathResource("static/images/").getFile().getAbsolutePath();
