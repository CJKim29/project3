	...
	<div id="box">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<div>
					<h4>제목 :</h4> <input class="form-control" name="board_name" value="${ vo.board_name }">
				</div>
				<div>
					<h4>내용 :</h4> <textarea class="form-control" rows="10" name="board_content" value="${ vo.board_content }"></textarea>
				</div>
