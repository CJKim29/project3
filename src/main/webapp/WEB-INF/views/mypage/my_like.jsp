                                 ...
                                 <c:forEach var="vo" items="${ list }">
                                    <tr>
                                       ...
                                       <td class="action" data-title="checkout">
                                          ...
                                          <c:choose>
                                             <c:when
                                                test="${ likeStatusMap[vo.performanceVo.performance_idx] == true }">
                                                <!-- 각 버튼에 고유한 ID 부여 -->
                                                <button type="button" id="love-${vo.performanceVo.performance_idx}"
                                                   class="btn min" style="background-color: #ff1d38;"
                                                   onclick="likeDown('${vo.performanceVo.performance_idx}')">
                                                   <i class="ti-heart"></i> &nbsp;
                                                </button>
                                             </c:when>
                                             <c:otherwise>
                                                <button type="button" id="love-${vo.performanceVo.performance_idx}"
                                                   class="btn min" style="background-color: #333333;"
                                                   onclick="likeUp('${vo.performanceVo.performance_idx}')">
                                                   <i class="ti-heart"></i> &nbsp;
                                                </button>
                                             </c:otherwise>
                                          </c:choose>
