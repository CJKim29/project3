							...
							<div class="col-12">
								...
								<div class="shop-top">
									...
									<ul class="view-mode">
										...
										<li class="active"><a href="shop-list.html"><i class="fa fa-th-list"></i></a>
										</li>
									</ul>
								</div>
								<!--/ End Shop Top -->
									...
									<div class="col-lg-8 col-md-6 col-12">
										<div class="list-content">
											<div class="product-content">
												...
												<h3 class="title"><a href="product-details.html">Women hot
														collection</a></h3>
											...
											<p class="des">nteger enim purus, posuere at ultricies eu, placerat a felis.
												Suspendisse aliquet urna pretium eros convallis interdum. Suspendisse
												aliquet urna pretium eros convallis interdum. Quisque in arcu id dui
												vulputate mollis eget non arcu. Aenean et nulla purus. Mauris vel tellus
												non nunc mattis lobortis We are creative company here are many variation
												generators on the Internet tend to chunks as necessary interdum</p>
