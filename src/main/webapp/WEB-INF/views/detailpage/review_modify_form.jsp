      ...
      <div class="container">
       <div class="row">
        <div class="col-12">
         ...
         <br /><br />
         <form id="ratingModifyForm" class="review-inner" method="POST" action="review_modify.do">
           ...
           <div class="row">
            <div class="col-lg-6 col-12">
             <div class="form-group">
              ...
              <input type="text" name="review_title" required="required" value="${ reviewVo.review_title }">
             </div>
            </div>
            <div class="col-lg-12 col-12">
             <div class="form-group">
              <label>내용<span>*</span></label>
              <textarea name="review_content" rows="6">${ reviewVo.review_content }</textarea>
             </div>
            </div>
            <div class="col-lg-12 col-12">
