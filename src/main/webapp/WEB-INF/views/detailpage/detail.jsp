              ...
              <div class="container">
                <div class="row">
                  <div class="col-lg-2 col-md-2 col-12">
                    <!-- Logo  -->
                    <div class="logo">
                      <a href="../main/list.do"><img src="../resources/template/images/logo_TIMOA1.png"
                          alt="logo" /></a>
                    </div>
                    <!--/ End Logo -->
                    ...
                    <div class="search-bar-top">
                      <div class="search-bar">
                        ...
                        <form id="searchForm" action="../performance/performance_search.do" method="GET"
                          ...
                          <input id="searchInput" name="search" placeholder="찾으실 공연을 입력해주세요" type="search" />
                          ...
                          <div class="navbar-collapse">
                            <div class="nav-inner">
                              <ul class="nav main-menu menu navbar-nav">
                                ...
                                <li><a href="../performance/category.do?performance_detail_cate_idx=1">뮤지컬</a>
                                </li>
                                <li><a href="../performance/category.do?performance_detail_cate_idx=2">콘서트</a>
                                </li>
                                <li><a href="../performance/category.do?performance_detail_cate_idx=3">연극</a>
                                </li>
                                <li>
                      ...
                      <div class="product-info">
                        <div class="nav-main">
                          ...
                          <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                              <a class="nav-link btn" id="performance-tab" onclick="toggleClickedEffect();"
                            ...
                            <li class="nav-item">
                              <a class="nav-link btn" id="reviews-tab"
                                onclick="review_list('${param.performance_idx}',1);" href="javascript:void(0);"
                                role="button">관람 후기</a>
                            </li>
