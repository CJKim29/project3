                              ...
                              <div class="search-bar-top">
                                 <div class="search-bar">
                                    ...
                                    <form id="searchForm" action="../performance/performance_search.do" method="GET"
                                       ...
                                       <input id="searchInput" name="search" placeholder="찾으실 공연 또는 공연장을 입력해주세요"
                                          type="search" />
                                          ...
                                          <c:choose>
                                             <c:when test="${isLiked}">
                                                <button type="button" id="love" class="btn min"
                                                   style="background-color: #ff1d38;" onclick="handleLikeClick();">
                                                   <i class="ti-heart"></i> &nbsp;
                                                   <span>${ likeCount }</span>
                                                </button>
                                             </c:when>
                                       ...
                                       <ul class="nav nav-tabs" id="myTab" role="tablist">
                                          <li class="nav-item">
                                             <a class="nav-link btn" id="performance-tab"
                                                onclick="toggleClickedEffect();" href="javascript:void(0);"
                                                role="button">공연정보</a>
                                          </li>
                        ...
                        <div class="modal-body" style="padding: 16px 25px 25px;">
                           ...
                           <div style="color: #666; font-size: 15px;">
                              <a href="${vo.hallVo.hall_site}" target="_blank">홈페이지 : ${vo.hallVo.hall_site}
                                 <i class="fi fi-sr-caret-right"
                                    style="display: inline-block; position: relative; top: 3px;"></i>
                              </a>
                           </div>
