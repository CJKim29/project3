				...
				<div id="box">
					...
					<div class="form-group form-group-lg">
						...
						<div class="profile_wrap">
							<div class="profile">
								<img style="width: 200px; height: 200px;" class="profile_img"
									src="../resources/images/${ vo.mem_filename }" id="my_img">
							</div>
			...
			<input type="button" value="변경하기" onclick="send_file(this.form);">
						...
						<div class="modify-content">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="mem_name" value="${ vo.mem_name }"
									placeholder="이름 입력">
							</div>
							<div class="form-group">
								<div class="text1">아이디 <span class="id_msg">*아이디는 수정이 불가합니다</span></div>
								<!-- id는 수정 불가하므로 읽기 전용 -->
								<input type="text" class="form-control" name="mem_id" value="${ vo.mem_id }"
									readonly="readonly">
							</div>
							<div class="form-group">
								<div class="text1">비밀번호</div>
								<input type="password" class="form-control" name="mem_pwd" value="${ vo.mem_pwd }"
									placeholder="비밀번호 입력">
							</div>
							<div class="form-group">
								<div class="text1">닉네임</div> <!-- 중복체크 위해 필요 -->
								<input type="text" class="form-control" name="mem_nickname" id="mem_nickname"
									placeholder="닉네임 입력" value="${ vo.mem_nickname }" onkeyup="check_nickname();">
							...
							<div class="form-group">
								...
								<input style="background-color: #2B2E36 !important;" class="a_search btn btn-lg"
									type="button" value="우편번호 검색" onclick="find_addr();">
							</div>
							<div class="form-group addr">
								<div class="text1">주소</div>
								<input style="width:395px" type="text" class="form-control" name="mem_addr"
									id="mem_addr" value="${ vo.mem_addr }" placeholder="상세주소 입력">
							</div>
							<div class="form-group">
								<div>
