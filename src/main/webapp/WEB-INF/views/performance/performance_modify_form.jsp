                    ...
                    <div class="panel-body">
                        ...
                        <div>
                            ...
                            <select class="form-control content" id="performance_cate_idx" name="performance_cate_idx"
                                value="${vo.performance_cate_idx}" onchange="select_d_cate();">
                            ...
                            <input id="datepicker_start" class="content" name="performance_startday"
                                value="${vo.performance_startday}" width="276" />

                            <h4>종료 일자</h4>
                            <input id="datepicker_end" class="content" name="performance_endday"
                                value="${vo.performance_endday}" width="276" />
                            ...
                            <h4>공연 이미지</h4>
                            <img src="../resources/images/${ vo.performance_image }">
                            <input class="form-control content" type="file" name="photo"
                                value="${vo.performance_image}">
