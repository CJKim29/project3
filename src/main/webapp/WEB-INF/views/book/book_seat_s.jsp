              ...
              <div>
                <c:choose>
                  <c:when test="${seat.s_hall_row_no <= 0}">
                    <!-- 기본 색상 클래스 유지 -->
                    <div
                      class="seat seat-row-${seat.s_hall_row_no} ${seat.a == 0 ? 'available' : 'unavailable'}"
                      data-row="${seat.s_hall_row_no}"
                      data-col="a"
                      data-seat="${seat.a}"
                    ></div>
                    <div
                      class="seat seat-row-${seat.s_hall_row_no} ${seat.b == 0 ? 'available' : 'unavailable'}"
                      data-row="${seat.s_hall_row_no}"
                      data-col="b"
                      data-seat="${seat.b}"
                    ></div>
                    <div
                      class="seat seat-row-${seat.s_hall_row_no} ${seat.c == 0 ? 'available' : 'unavailable'}"
                      data-row="${seat.s_hall_row_no}"
                      data-col="c"
                      data-seat="${seat.c}"
                    ></div>
                    <div
                      class="seat seat-row-${seat.s_hall_row_no} ${seat.d == 0 ? 'available' : 'unavailable'}"
                      data-row="${seat.s_hall_row_no}"
                      data-col="d"
                      data-seat="${seat.d}"
                    ></div>
                    <div
                      class="seat seat-row-${seat.s_hall_row_no} ${seat.e == 0 ? 'available' : 'unavailable'}"
                      data-row="${seat.s_hall_row_no}"
                      data-col="e"
                      data-seat="${seat.e}"
                    ></div>
                    <div
                      class="seat seat-row-${seat.s_hall_row_no} ${seat.f == 0 ? 'available' : 'unavailable'}"
                      data-row="${seat.s_hall_row_no}"
                      data-col="f"
                      data-seat="${seat.f}"
                    ></div>
                    <div
                      class="seat seat-row-${seat.s_hall_row_no} ${seat.g == 0 ? 'available' : 'unavailable'}"
                      data-row="${seat.s_hall_row_no}"
                      data-col="g"
                      data-seat="${seat.g}"
                    ></div>
                    <div
                      class="seat seat-row-${seat.s_hall_row_no} ${seat.h == 0 ? 'available' : 'unavailable'}"
                      data-row="${seat.s_hall_row_no}"
                      data-col="h"
                      data-seat="${seat.h}"
                    ></div>
                    <div
                      class="seat seat-row-${seat.s_hall_row_no} ${seat.i == 0 ? 'available' : 'unavailable'}"
                      data-row="${seat.s_hall_row_no}"
                      data-col="i"
                      data-seat="${seat.i}"
                    ></div>
                    <div
                      class="seat seat-row-${seat.s_hall_row_no} ${seat.j == 0 ? 'available' : 'unavailable'}"
                      data-row="${seat.s_hall_row_no}"
                      data-col="j"
                      data-seat="${seat.j}"
                    ></div>
                  ...
                  <c:otherwise>
                    ...
                    <div
                      class="seat ${rowClass} seat-row-${seat.s_hall_row_no} ${seat.a == 0 ? 'available' : 'unavailable'}"
                      data-row="${seat.s_hall_row_no}"
                      data-col="a"
                      data-seat="${seat.a}"
                    ></div>
                    <div
                      class="seat ${rowClass} seat-row-${seat.s_hall_row_no} ${seat.b == 0 ? 'available' : 'unavailable'}"
                      data-row="${seat.s_hall_row_no}"
                      data-col="b"
                      data-seat="${seat.b}"
                    ></div>
                    <div
                      class="seat ${rowClass} seat-row-${seat.s_hall_row_no} ${seat.c == 0 ? 'available' : 'unavailable'}"
                      data-row="${seat.s_hall_row_no}"
                      data-col="c"
                      data-seat="${seat.c}"
                    ></div>
                    <div
                      class="seat ${rowClass} seat-row-${seat.s_hall_row_no} ${seat.d == 0 ? 'available' : 'unavailable'}"
                      data-row="${seat.s_hall_row_no}"
                      data-col="d"
                      data-seat="${seat.d}"
                    ></div>
                    <div
                      class="seat ${rowClass} seat-row-${seat.s_hall_row_no} ${seat.e == 0 ? 'available' : 'unavailable'}"
                      data-row="${seat.s_hall_row_no}"
                      data-col="e"
                      data-seat="${seat.e}"
                    ></div>
                    <div
                      class="seat ${rowClass} seat-row-${seat.s_hall_row_no} ${seat.f == 0 ? 'available' : 'unavailable'}"
                      data-row="${seat.s_hall_row_no}"
                      data-col="f"
                      data-seat="${seat.f}"
                    ></div>
                    <div
                      class="seat ${rowClass} seat-row-${seat.s_hall_row_no} ${seat.g == 0 ? 'available' : 'unavailable'}"
                      data-row="${seat.s_hall_row_no}"
                      data-col="g"
                      data-seat="${seat.g}"
                    ></div>
                    <div
                      class="seat ${rowClass} seat-row-${seat.s_hall_row_no} ${seat.h == 0 ? 'available' : 'unavailable'}"
                      data-row="${seat.s_hall_row_no}"
                      data-col="h"
                      data-seat="${seat.h}"
                    ></div>
                    <div
                      class="seat ${rowClass} seat-row-${seat.s_hall_row_no} ${seat.i == 0 ? 'available' : 'unavailable'}"
                      data-row="${seat.s_hall_row_no}"
                      data-col="i"
                      data-seat="${seat.i}"
                    ></div>
                    <div
                      class="seat ${rowClass} seat-row-${seat.s_hall_row_no} ${seat.j == 0 ? 'available' : 'unavailable'}"
                      data-row="${seat.s_hall_row_no}"
                      data-col="j"
                      data-seat="${seat.j}"
                    ></div>
