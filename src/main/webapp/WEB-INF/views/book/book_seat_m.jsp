          ...
          <div>
           <c:choose>
            <c:when test="${seat.m_hall_row_no <= 0}">
             <!-- 기본 색상 클래스 유지 -->
             <div class="seat seat-row-${seat.m_hall_row_no} ${seat.a == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.m_hall_row_no}" data-col="a" data-seat="${seat.a}"></div>
             <div class="seat seat-row-${seat.m_hall_row_no} ${seat.b == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.m_hall_row_no}" data-col="b" data-seat="${seat.b}"></div>
             <div class="seat seat-row-${seat.m_hall_row_no} ${seat.c == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.m_hall_row_no}" data-col="c" data-seat="${seat.c}"></div>
             <div class="seat seat-row-${seat.m_hall_row_no} ${seat.d == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.m_hall_row_no}" data-col="d" data-seat="${seat.d}"></div>
             <div class="seat seat-row-${seat.m_hall_row_no} ${seat.e == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.m_hall_row_no}" data-col="e" data-seat="${seat.e}"></div>
             <div class="seat seat-row-${seat.m_hall_row_no} ${seat.f == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.m_hall_row_no}" data-col="f" data-seat="${seat.f}"></div>
             <div class="seat seat-row-${seat.m_hall_row_no} ${seat.g == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.m_hall_row_no}" data-col="g" data-seat="${seat.g}"></div>
             <div class="seat seat-row-${seat.m_hall_row_no} ${seat.h == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.m_hall_row_no}" data-col="h" data-seat="${seat.h}"></div>
             <div class="seat seat-row-${seat.m_hall_row_no} ${seat.i == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.m_hall_row_no}" data-col="i" data-seat="${seat.i}"></div>
             <div class="seat seat-row-${seat.m_hall_row_no} ${seat.j == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.m_hall_row_no}" data-col="j" data-seat="${seat.j}"></div>
             <div class="seat seat-row-${seat.m_hall_row_no} ${seat.k == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.m_hall_row_no}" data-col="k" data-seat="${seat.k}"></div>
             <div class="seat seat-row-${seat.m_hall_row_no} ${seat.l == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.m_hall_row_no}" data-col="l" data-seat="${seat.l}"></div>
             <div class="seat seat-row-${seat.m_hall_row_no} ${seat.m == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.m_hall_row_no}" data-col="m" data-seat="${seat.m}"></div>
             <div class="seat seat-row-${seat.m_hall_row_no} ${seat.n == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.m_hall_row_no}" data-col="n" data-seat="${seat.n}"></div>
             <div class="seat seat-row-${seat.m_hall_row_no} ${seat.o == 0 ? 'available' : 'unavailable'}"
            ...
            <c:otherwise>
             <c:choose>
              ...
              <c:when test="${fn:length(vo.seatList) == 4}">
               <c:choose>
                <c:when test="${seat.m_hall_row_no == 1 || seat.m_hall_row_no == 2 || seat.m_hall_row_no == 3}">
                 <c:set var="rowClass" value="seat-purple" />
                </c:when>
                <c:when
              ...
              <c:when test="${fn:length(vo.seatList) == 5}">
               <c:choose>
                ...
                <c:when test="${seat.m_hall_row_no == 3 || seat.m_hall_row_no == 4 || seat.m_hall_row_no == 5}">
                 <c:set var="rowClass" value="seat-green" />
                </c:when>
                <c:when test="${seat.m_hall_row_no == 6 || seat.m_hall_row_no == 7 || seat.m_hall_row_no == 8}">
                 <c:set var="rowClass" value="seat-blue" />
                </c:when>
                <c:when test="${seat.m_hall_row_no == 9 || seat.m_hall_row_no == 10 || seat.m_hall_row_no == 11}">
                 <c:set var="rowClass" value="seat-orange" />
                </c:when>
                <c:otherwise>
              ...
              <c:otherwise>
               <c:choose>
                ...
                <c:when test="${seat.m_hall_row_no == 12 || seat.m_hall_row_no == 13 || seat.m_hall_row_no == 14}">
                 <c:set var="rowClass" value="seat-orange" />
                </c:when>
                <c:otherwise>
             ...
             <div class="seat ${rowClass} seat-row-${seat.m_hall_row_no} ${seat.a == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.m_hall_row_no}" data-col="a" data-seat="${seat.a}"></div>
             <div class="seat ${rowClass} seat-row-${seat.m_hall_row_no} ${seat.b == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.m_hall_row_no}" data-col="b" data-seat="${seat.b}"></div>
             <div class="seat ${rowClass} seat-row-${seat.m_hall_row_no} ${seat.c == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.m_hall_row_no}" data-col="c" data-seat="${seat.c}"></div>
             <div class="seat ${rowClass} seat-row-${seat.m_hall_row_no} ${seat.d == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.m_hall_row_no}" data-col="d" data-seat="${seat.d}"></div>
             <div class="seat ${rowClass} seat-row-${seat.m_hall_row_no} ${seat.e == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.m_hall_row_no}" data-col="e" data-seat="${seat.e}"></div>
             <div class="seat ${rowClass} seat-row-${seat.m_hall_row_no} ${seat.f == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.m_hall_row_no}" data-col="f" data-seat="${seat.f}"></div>
             <div class="seat ${rowClass} seat-row-${seat.m_hall_row_no} ${seat.g == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.m_hall_row_no}" data-col="g" data-seat="${seat.g}"></div>
             <div class="seat ${rowClass} seat-row-${seat.m_hall_row_no} ${seat.h == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.m_hall_row_no}" data-col="h" data-seat="${seat.h}"></div>
             <div class="seat ${rowClass} seat-row-${seat.m_hall_row_no} ${seat.i == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.m_hall_row_no}" data-col="i" data-seat="${seat.i}"></div>
             <div class="seat ${rowClass} seat-row-${seat.m_hall_row_no} ${seat.j == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.m_hall_row_no}" data-col="j" data-seat="${seat.j}"></div>
             <div class="seat ${rowClass} seat-row-${seat.m_hall_row_no} ${seat.k == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.m_hall_row_no}" data-col="k" data-seat="${seat.k}"></div>
             <div class="seat ${rowClass} seat-row-${seat.m_hall_row_no} ${seat.l == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.m_hall_row_no}" data-col="l" data-seat="${seat.l}"></div>
             <div class="seat ${rowClass} seat-row-${seat.m_hall_row_no} ${seat.m == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.m_hall_row_no}" data-col="m" data-seat="${seat.m}"></div>
             <div class="seat ${rowClass} seat-row-${seat.m_hall_row_no} ${seat.n == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.m_hall_row_no}" data-col="n" data-seat="${seat.n}"></div>
             <div class="seat ${rowClass} seat-row-${seat.m_hall_row_no} ${seat.o == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.m_hall_row_no}" data-col="o" data-seat="${seat.o}"></div>
