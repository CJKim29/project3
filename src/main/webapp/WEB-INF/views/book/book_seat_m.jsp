                      ...
                      <c:choose>
                        <c:when test="${seat.m_hall_row_no <= 0}">
                          ...
                          <div
                            ...
                            data-row="${seat.m_hall_row_no}" data-col="m_hall_a" data-seat="${seat.m_hall_a}"></div>
                          <div
                            class="seat seat-row-${seat.m_hall_row_no} ${seat.m_hall_b == 0 ? 'available' : 'unavailable'}"
                            data-row="${seat.m_hall_row_no}" data-col="m_hall_b" data-seat="${seat.m_hall_b}"></div>
                          <div
                            class="seat seat-row-${seat.m_hall_row_no} ${seat.m_hall_c == 0 ? 'available' : 'unavailable'}"
                            data-row="${seat.m_hall_row_no}" data-col="m_hall_c" data-seat="${seat.m_hall_c}"></div>
                          <div
                            class="seat seat-row-${seat.m_hall_row_no} ${seat.m_hall_d == 0 ? 'available' : 'unavailable'}"
                            data-row="${seat.m_hall_row_no}" data-col="m_hall_d" data-seat="${seat.m_hall_d}"></div>
                          <div
                            class="seat seat-row-${seat.m_hall_row_no} ${seat.m_hall_e == 0 ? 'available' : 'unavailable'}"
                            data-row="${seat.m_hall_row_no}" data-col="m_hall_e" data-seat="${seat.m_hall_e}"></div>
                          <div
                            class="seat seat-row-${seat.m_hall_row_no} ${seat.m_hall_f == 0 ? 'available' : 'unavailable'}"
                            data-row="${seat.m_hall_row_no}" data-col="m_hall_f" data-seat="${seat.m_hall_f}"></div>
                          <div
                            class="seat seat-row-${seat.m_hall_row_no} ${seat.m_hall_g == 0 ? 'available' : 'unavailable'}"
                            data-row="${seat.m_hall_row_no}" data-col="m_hall_g" data-seat="${seat.m_hall_g}"></div>
                          <div
                            class="seat seat-row-${seat.m_hall_row_no} ${seat.m_hall_h == 0 ? 'available' : 'unavailable'}"
                            data-row="${seat.m_hall_row_no}" data-col="m_hall_h" data-seat="${seat.m_hall_h}"></div>
                          <div
                            class="seat seat-row-${seat.m_hall_row_no} ${seat.m_hall_i == 0 ? 'available' : 'unavailable'}"
                            data-row="${seat.m_hall_row_no}" data-col="m_hall_i" data-seat="${seat.m_hall_i}"></div>
                          <div
                            class="seat seat-row-${seat.m_hall_row_no} ${seat.m_hall_j == 0 ? 'available' : 'unavailable'}"
                            data-row="${seat.m_hall_row_no}" data-col="m_hall_j" data-seat="${seat.m_hall_j}"></div>
                          <div
                            class="seat seat-row-${seat.m_hall_row_no} ${seat.m_hall_k == 0 ? 'available' : 'unavailable'}"
                            data-row="${seat.m_hall_row_no}" data-col="m_hall_k" data-seat="${seat.m_hall_k}"></div>
                          <div
                            class="seat seat-row-${seat.m_hall_row_no} ${seat.m_hall_l == 0 ? 'available' : 'unavailable'}"
                            data-row="${seat.m_hall_row_no}" data-col="m_hall_l" data-seat="${seat.m_hall_l}"></div>
                          <div
                            class="seat seat-row-${seat.m_hall_row_no} ${seat.m_hall_m == 0 ? 'available' : 'unavailable'}"
                            data-row="${seat.m_hall_row_no}" data-col="m_hall_m" data-seat="${seat.m_hall_m}"></div>
                          <div
                            class="seat seat-row-${seat.m_hall_row_no} ${seat.m_hall_n == 0 ? 'available' : 'unavailable'}"
                            data-row="${seat.m_hall_row_no}" data-col="m_hall_n" data-seat="${seat.m_hall_n}"></div>
                          <div
                            class="seat seat-row-${seat.m_hall_row_no} ${seat.m_hall_o == 0 ? 'available' : 'unavailable'}"
                            data-row="${seat.m_hall_row_no}" data-col="m_hall_o" data-seat="${seat.m_hall_o}"></div>
              ...
              ">
                  ...
                  <div class="seat-container4">
                    ...
                    <form id="bookForm" action="book_reservation.do" method="post">
                      <input type="hidden" name="performance_idx" value="${param.performance_idx}" />
                      <input type="hidden" name="date" value="${param.date}" />
                      <input type="button" class="btn btn-danger" value="장바구니 담기" onclick="submitBookForm(this.form)" />
                    </form>
                  </div>
                </div>
              </div>
