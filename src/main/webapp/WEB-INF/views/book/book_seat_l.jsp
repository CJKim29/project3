  ...
  <%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
   <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
    ...
    <head>
     ...
     <link rel="stylesheet" href="../resources/css/book/book_seat_l.css" />
      ...
      <div id="seat-box-body-left">
       <div class="seat-container">
        ...
        <div id="seat-box-body-left-button">
          <strong style="margin-left: 5px; font-size: 10px;" >
            A&nbsp;&nbsp;&nbsp;&nbsp; B&nbsp;&nbsp;&nbsp;&nbsp;
            C&nbsp;&nbsp;&nbsp;&nbsp; D&nbsp;&nbsp;&nbsp;
            E&nbsp;&nbsp;&nbsp;&nbsp; F&nbsp;&nbsp;&nbsp;&nbsp;
            G&nbsp;&nbsp;&nbsp; H&nbsp;&nbsp;&nbsp;&nbsp;
          ...
          <div>
           <c:choose>
            <c:when test="${seat.l_hall_row_no <= 0}">
             <!-- 기본 색상 클래스 유지 -->
             <div class="seat seat-row-${seat.l_hall_row_no} ${seat.a == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="a" data-seat="${seat.a}"></div>
             <div class="seat seat-row-${seat.l_hall_row_no} ${seat.b == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="b" data-seat="${seat.b}"></div>
             <div class="seat seat-row-${seat.l_hall_row_no} ${seat.c == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="c" data-seat="${seat.c}"></div>
             <div class="seat seat-row-${seat.l_hall_row_no} ${seat.d == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="d" data-seat="${seat.d}"></div>
             <div class="seat seat-row-${seat.l_hall_row_no} ${seat.e == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="e" data-seat="${seat.e}"></div>
             <div class="seat seat-row-${seat.l_hall_row_no} ${seat.f == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="f" data-seat="${seat.f}"></div>
             <div class="seat seat-row-${seat.l_hall_row_no} ${seat.g == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="g" data-seat="${seat.g}"></div>
             <div class="seat seat-row-${seat.l_hall_row_no} ${seat.h == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="h" data-seat="${seat.h}"></div>
             <div class="seat seat-row-${seat.l_hall_row_no} ${seat.i == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="i" data-seat="${seat.i}"></div>
             <div class="seat seat-row-${seat.l_hall_row_no} ${seat.j == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="j" data-seat="${seat.j}"></div>
             <div class="seat seat-row-${seat.l_hall_row_no} ${seat.k == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="k" data-seat="${seat.k}"></div>
             <div class="seat seat-row-${seat.l_hall_row_no} ${seat.l == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="l" data-seat="${seat.l}"></div>
             <div class="seat seat-row-${seat.l_hall_row_no} ${seat.m == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="m" data-seat="${seat.m}"></div>
             <div class="seat seat-row-${seat.l_hall_row_no} ${seat.n == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="n" data-seat="${seat.n}"></div>
             <div class="seat seat-row-${seat.l_hall_row_no} ${seat.o == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="o" data-seat="${seat.o}"></div>
             <div class="seat seat-row-${seat.l_hall_row_no} ${seat.p == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="p" data-seat="${seat.p}"></div>
             <div class="seat seat-row-${seat.l_hall_row_no} ${seat.q == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="q" data-seat="${seat.q}"></div>
             <div class="seat seat-row-${seat.l_hall_row_no} ${seat.r == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="r" data-seat="${seat.r}"></div>
             <div class="seat seat-row-${seat.l_hall_row_no} ${seat.s == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="s" data-seat="${seat.s}"></div>
             <div class="seat seat-row-${seat.l_hall_row_no} ${seat.t == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="t" data-seat="${seat.t}"></div>
            ...
            <c:otherwise>
             <c:choose>
              ...
              <c:when test="${fn:length(vo.seatList) == 5}">
               <c:choose>
                <c:when test="${seat.l_hall_row_no == 1 || seat.l_hall_row_no == 2 || seat.l_hall_row_no == 3}">
                 <c:set var="rowClass" value="seat-purple" />
                </c:when>
                <c:when
             ...
             <div class="seat ${rowClass} seat-row-${seat.l_hall_row_no} ${seat.a == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="a" data-seat="${seat.a}"></div>
             <div class="seat ${rowClass} seat-row-${seat.l_hall_row_no} ${seat.b == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="b" data-seat="${seat.b}"></div>
             <div class="seat ${rowClass} seat-row-${seat.l_hall_row_no} ${seat.c == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="c" data-seat="${seat.c}"></div>
             <div class="seat ${rowClass} seat-row-${seat.l_hall_row_no} ${seat.d == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="d" data-seat="${seat.d}"></div>
             <div class="seat ${rowClass} seat-row-${seat.l_hall_row_no} ${seat.e == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="e" data-seat="${seat.e}"></div>
             <div class="seat ${rowClass} seat-row-${seat.l_hall_row_no} ${seat.f == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="f" data-seat="${seat.f}"></div>
             <div class="seat ${rowClass} seat-row-${seat.l_hall_row_no} ${seat.g == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="g" data-seat="${seat.g}"></div>
             <div class="seat ${rowClass} seat-row-${seat.l_hall_row_no} ${seat.h == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="h" data-seat="${seat.h}"></div>
             <div class="seat ${rowClass} seat-row-${seat.l_hall_row_no} ${seat.i == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="i" data-seat="${seat.i}"></div>
             <div class="seat ${rowClass} seat-row-${seat.l_hall_row_no} ${seat.j == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="j" data-seat="${seat.j}"></div>
             <div class="seat ${rowClass} seat-row-${seat.l_hall_row_no} ${seat.k == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="k" data-seat="${seat.k}"></div>
             <div class="seat ${rowClass} seat-row-${seat.l_hall_row_no} ${seat.l == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="l" data-seat="${seat.l}"></div>
             <div class="seat ${rowClass} seat-row-${seat.l_hall_row_no} ${seat.m == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="m" data-seat="${seat.m}"></div>
             <div class="seat ${rowClass} seat-row-${seat.l_hall_row_no} ${seat.n == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="n" data-seat="${seat.n}"></div>
             <div class="seat ${rowClass} seat-row-${seat.l_hall_row_no} ${seat.o == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="o" data-seat="${seat.o}"></div>
             <div class="seat ${rowClass} seat-row-${seat.l_hall_row_no} ${seat.p == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="p" data-seat="${seat.p}"></div>
             <div class="seat ${rowClass} seat-row-${seat.l_hall_row_no} ${seat.q == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="q" data-seat="${seat.q}"></div>
             <div class="seat ${rowClass} seat-row-${seat.l_hall_row_no} ${seat.r == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="r" data-seat="${seat.r}"></div>
             <div class="seat ${rowClass} seat-row-${seat.l_hall_row_no} ${seat.s == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="s" data-seat="${seat.s}"></div>
             <div class="seat ${rowClass} seat-row-${seat.l_hall_row_no} ${seat.t == 0 ? 'available' : 'unavailable'}"
              data-row="${seat.l_hall_row_no}" data-col="t" data-seat="${seat.t}"></div>
